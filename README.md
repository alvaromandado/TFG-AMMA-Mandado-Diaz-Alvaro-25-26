...
| :--- | :--- | :--- | :--- | :--- |
| **Cap. 3** | `/QuTiP` | `GRAPE_QuTiP.py`, `CRAB_QuTiP.py` | `grape_qutip.png`, `crab_qutip.png` | Uso del paquete QuTiP para encontrar óptimamente la puerta CNOT. |
| **Cap. 3** | `/SciPy` | `GRAPE_SciPy.py`, `CRAB_SciPy.py` | `grape_scipy.png`, `crab_scipy.png` | Uso del paquete SciPy para encontrar óptimamente la puerta CNOT. |
